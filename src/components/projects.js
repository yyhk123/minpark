              ...
              >
                <CardTitle
                  ...
                  style={{
                    ...
                    color: "black",
                    background:
                      "url(https://i.imgur.com/ISOUDEq.png) bottom right 15% no-repeat #46B6AC",
                    backgroundPosition: "center",
                    backgroundRepeat: "no-repeat",
                    backgroundSize: "cover",
                  }}
                ></CardTitle>
                <CardText>MERN Login</CardText>
                <CardActions border>
                  <Button
                    colored
                    href="https://github.com/yyhk123/MERN"
                    target="_blank"
                  >
                    Github
                  </Button>
              ...
              >
                <CardTitle
                  ...
                  style={{
                    ...
                    color: "black",
                    background:
                      "url(https://i.imgur.com/I2kFzFq.png) bottom right 15% no-repeat #46B6AC",
                    backgroundPosition: "center",
                    backgroundRepeat: "no-repeat",
                    backgroundSize: "cover",
                  }}
                ></CardTitle>
                <CardText>Android App - IdolCup</CardText>
                <CardActions border>
                  <Button
                    colored
                    href="https://github.com/yyhk123/IdolCup/tree/master"
                    target="_blank"
                  >
                    Github
                  </Button>
